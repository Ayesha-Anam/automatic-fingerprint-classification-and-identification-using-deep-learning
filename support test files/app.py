...
speak("I am BOTA! a voice assistant robot")
speak("Once a match is found, results will be displayed!")
speak("I'm off now! have a nice day!")

#sample
sample = cv2.imread("101__M_Left_little_finger.bmp")
...
# Displaying Results
print("-----RESULTS-----")
print(f"Best Match: {filename.split('.')[0]}")
print("Score: " + str(best_score))
speak("we found match of"+filename.split('.')[0])
print("")
